...
/* Declare and init the head node of linked list */
LIST_HEAD(Head_Node);
...
void workqueue_fn(struct work_struct *work)
{
	...
	/* Assign the data that is recevied */
	temp_node->data = my_val;
                ...
                char __user *buf, size_t len, loff_t *off)
{
	...
	/* Travesing Linked List and Print its Members */
                ...
                const char __user *buf, size_t len, loff_t *off)
{
	...
	asm("int $0x3B"); // Corresponding to irq11
        return len;
}
